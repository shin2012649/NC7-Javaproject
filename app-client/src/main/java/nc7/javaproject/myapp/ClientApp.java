...
import nc7.javaproject.myapp.dao.BoardNetworkDao;
import nc7.javaproject.myapp.dao.ParticipantDao;
import nc7.javaproject.myapp.dao.ParticipantNetworkDao;
...
public class ClientApp {
  ...
  public ClientApp(String ip, int port) throws Exception {
    ...
    this.participantDao = new ParticipantNetworkDao("participant", in, out);
