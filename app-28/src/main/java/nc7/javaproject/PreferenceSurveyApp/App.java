...
import nc7.javaproject.io.BufferedDataInputStream;
import nc7.javaproject.io.BufferedDataOutputStream;
...
public class App {
  ...
  private void loadParticipant() {
    try {
      BufferedDataInputStream in = new BufferedDataInputStream("participant.data");
...
//          list.get(list.size() - 1).getNo() + 1);
  ...
  private void saveParticipant() {
    try {
      BufferedDataOutputStream out = new BufferedDataOutputStream("participant.data");
