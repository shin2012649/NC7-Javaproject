...
public class ServerApp {
  ...
  public static final String JAVAPROJECT_SESSION_ID = "javaproject_session_id";
  ...
  public void close() throws Exception {
    ...
    private NettyOutbound processRequest(HttpServerRequest request, HttpServerResponse response) {
      ...
      try {
        ...
        List<Cookie> cookies = request2.allCookies().get(JAVAPROJECT_SESSION_ID);
        if (cookies != null) {
        ...
        if (firstVisit) {
          ...
          response.addCookie(new DefaultCookie(JAVAPROJECT_SESSION_ID, sessionId));
        }
