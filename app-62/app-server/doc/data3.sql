-- javaproject_user 테이블 예제 데이터
insert into javaproject_user(user_no, name, email, password, gender) 
...
-- javaproject_board_category 테이블 예제 데이터
insert into javaproject_board_category(board_category_no, name) values(1, '게시판');
insert into javaproject_board_category(board_category_no, name) values(2, '독서록');
  
-- javaproject_board 테이블 예제 데이터
