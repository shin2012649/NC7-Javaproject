...
@ComponentScan(basePackages = {
        "nc7.javaproject.dao",
        "nc7.javaproject.controller",
        "nc7.javaproject.service"})
@PropertySource({"classpath:nc7/javaproject/config/ncloud/jdbc.properties"})
@MapperScan("nc7.javaproject.dao") // Mybatis가 자동으로 생성할 DAO 객체의 인터페이스 패키지 지정
...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(DataSource dataSource, ApplicationContext appCtx) throws Exception {
    ...
    factoryBean.setTypeAliasesPackage("nc7.javaproject.vo");
    factoryBean.setMapperLocations(appCtx.getResources("classpath:nc7/javaproject/dao/mysql/*Dao.xml"));
