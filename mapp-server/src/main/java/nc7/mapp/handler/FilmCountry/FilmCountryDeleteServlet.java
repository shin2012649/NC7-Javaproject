...
@WebServlet("/filmcountry/delete")
public class FilmCountryDeleteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // FilmCountryDao를 이용하여 데이터베이스에서 FilmCountry 삭제
            FilmCountryDao filmCountryDao = new MySQLFilmCountryDao(sqlSessionFactory);
            filmCountryDao.delete(filmNo, countryNo);
