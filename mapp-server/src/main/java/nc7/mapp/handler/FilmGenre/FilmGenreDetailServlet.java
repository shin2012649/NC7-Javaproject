...
@WebServlet("/filmgenre/detail")
public class FilmGenreDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<FilmGenre> filmGenreList = filmGenreDao.findByFilmNo(filmNo);
            ...
            // JSP로 포워드
            // request.getRequestDispatcher("/filmgenre_detail.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
            // 오류 처리 코드
        }
