...
@WebServlet("/filmgenre/delete")
public class FilmGenreDeleteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // FilmGenreDao를 이용하여 데이터베이스에서 FilmGenre 삭제
            FilmGenreDao filmGenreDao = new MySQLFilmGenreDao(sqlSessionFactory);
            filmGenreDao.deleteByFilmNo(filmNo);
