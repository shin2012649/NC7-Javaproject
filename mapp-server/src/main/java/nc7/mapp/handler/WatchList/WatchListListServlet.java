...
@WebServlet("/watchlist/list")
public class WatchListListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // 사용자 번호를 가져와 WatchListDao를 이용하여 관심 목록 조회
            ...
            request.getRequestDispatcher("/watchlist_list.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
            // 오류 처리 코드
        }
