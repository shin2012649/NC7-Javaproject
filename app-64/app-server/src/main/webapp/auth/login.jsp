...
<jsp:useBean id="m" class="nc7.javaproject.vo.User" scope="page"/>
...
<c:set var="loginUser" value="${userDao.findByEmailAndPassword(m)}" scope="session"/>

<jsp:useBean id="loginUser" type="nc7.javaproject.vo.User" scope="session"/>
<c:redirect url="/"/>
